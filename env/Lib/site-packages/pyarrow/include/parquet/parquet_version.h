...
#define PARQUET_VERSION_MAJOR 18
#define PARQUET_VERSION_MINOR 1
#define PARQUET_VERSION_PATCH 0

#define PARQUET_SO_VERSION "1801"
#define PARQUET_FULL_SO_VERSION "1801.0.0"

// define the parquet created by version
#define CREATED_BY_VERSION "parquet-cpp-arrow version 18.1.0"
